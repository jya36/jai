...
class Chatbot:
    def __init__(self):
        ...
        self.azure_endpoint = f"https://oaiep.openai.azure.com/"
        ...
        self.model_client_reason = AzureOpenAIChatCompletionClient(
            azure_endpoint=self.azure_endpoint,
            model="o4-mini",
            azure_deployment="o4-mini",
            api_version=self.azure_api_version,
            api_key=self.azure_api_key,
            model_info=model_info_reason
        )
    ...
    def nmap_scan(self, network: str) -> str:
        print(Fore.RED + f"\nRunning network scan on {network}...")
